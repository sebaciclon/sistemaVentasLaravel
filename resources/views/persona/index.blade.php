...
@endif
    ...
    <div class="container-fluid px-4">
        ...
        <a href="{{ route('personas.create')}}"><button type="button" class="btn btn-primary mb-4">Añadir nuevo cliente</button></a>
                        ...
                        @foreach ($personas as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <form action="{{ route('personas.edit', ['persona' => $item->persona]) }}" method="GET">
                                            @csrf
                            ...
                            <div class="modal fade" id="exampleModal-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('personas.destroy', ['persona' => $item->persona->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
